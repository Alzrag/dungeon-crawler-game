...
SOURCE= main.cpp Engine.cpp helpers.cpp GameObject.cpp staticobject.cpp fixed.cpp map.cpp enimy.cpp
#any additional header files you need
H_FILES = vertex_data.hpp helpers.h Engine.h GameObject.h staticobject.h fixed.h map.h enimy.h
...
CXX_FLAGS = -Wall -Wextra -Wconversion -Wdouble-promotion -Wunreachable-code -Wshadow -Wpedantic \
            -Iexternal/glfw-3.4/include -Iexternal/Vulkan-Headers/include -Iexternal -DNDEBUG
CPPVERSION = -std=c++17
