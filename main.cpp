  ...
  //in effect we are building our own error statement here
    ...
    void createTextureImage(){
      ...
      if(vkAllocateMemory(device, &allocInfo, nullptr, &textureImageMemory)!=VK_SUCCESS){
        throw std::runtime_error("")//stoped here^
      }
    }
    ...
    void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size){
      ...
      //start recording commands for the command buffer
      VkCommandBufferBeginInfo beginInfo{};
      beginInfo.sType=VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
      ...
      vkFreeCommandBuffers(device,commandPool,1,&commandBuffer);//internally this is a fence to wait until transfer finishes.
    }
